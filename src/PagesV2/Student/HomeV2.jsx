    ...
    <div className="home-layout">
      <div className="top-bar">
        ...
        <div
          ...
          onClick={() => toggleDropdown("userbtn")}
        >
        ...
        {showDropdown.userbtn && (
          ...
          >
            ...
            <div
              ...
              onClick={() => toggleDropdown("userbtn_2")}
            >
              <a
            ...
            <div
              className="nested-dropdown"
              onClick={() => toggleDropdown("userbtn_3")}
            >
              <Link to="/user_settings" className="link-button">
                User Settings
              </Link>
            </div>
            <div
              className="nested-dropdown"
              onClick={() => toggleDropdown("userbtn_4")}
            >
              <a
            ...
            <div
              className="nested-dropdown"
              onClick={() => toggleDropdown("userbtn_5")}
            >
              <Link to="/log_out" className="link-button">
                Log out
              </Link>
            </div>
          </div>
